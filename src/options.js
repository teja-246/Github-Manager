...
export class Options {
    constructor(
        ...
        this.system_message = system_message
        this.openai_model = openai_model || 'gpt-3.5-turbo'
        this.openai_model_temperature = parseFloat(openai_model_temperature || '0.0')
        this.openai_retries = parseInt(openai_retries || '3')
        this.openai_timeout_ms = parseInt(openai_timeout_ms || '60000')
        this.openai_concurrency_limit = parseInt(openai_concurrency_limit || '4')
